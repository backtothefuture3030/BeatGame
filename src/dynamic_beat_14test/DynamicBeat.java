...
public class DynamicBeat extends JFrame { // gui 프로그램을 하기위해 무조건 상속받아야하는 JFrame 이미 존재하는 라이브러리
	...
	public static Game game;	// 여러곡을 재생시키면서 게임 불가능, 한가지만 할수있게 만든거임
	
	
	public DynamicBeat() { // 생성자
		trackList.add(new Track("Skyfall Title Image.png","Skyfall Start Image.jpg",
				"Skyfall Game Image.jpg","Skyfall Selected.mp3","LeeHi-Skyfall.mp3","LeeHi-Skyfall"));
		trackList.add(new Track("PrettySavage Title Image.png","PrettySavage Start Image.jpg",
				"PrettySavage Game Image.jpg","PrettySavage Selected.mp3","BlackPink-PrettySavage.mp3","BlackPink-PrettySavage"));
		
		trackList.add(new Track("Rose Title Image.png","Rose Start Image.jpg",
				"Rose Game Image.jpg","Rose Selected.mp3","LeeHi-Rose.mp3","LeeHi-Rose"));
		...
		addKeyListener(new KeyListener());	// KeyListener 클래스만든후 적용시키기 과정
	...
	public void gameStart(int nowSelected, String difficulty) {
		...
		game.start();
		setFocusable(true);	// 메인창에 키보드 포커스가 맞춰지게된다
